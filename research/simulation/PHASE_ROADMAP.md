...
- [ ] **5/12**: `mujoco.Renderer`로 RGB 이미지 추출 검증 **(차단됨: mjpython/claude CLI 문제)**
- [ ] **5/13**: 카메라 캘리브레이션 파라미터 적용 (FOV, 해상도)
- [ ] **5/14**: 두 카메라 동시 캡처 + 동기화 검증 (BLOCKED by external dependencies)
