...
<!-- slide title="사용 기술 카드 5개" screenshot="" -->
...
<!-- slide title="학습 데이터셋 + AI 학습 1사이클" screenshot="" -->
...
<!-- slide title="의사결정 근거 + 차년도 계획" screenshot="" -->
**의사결정 근거 (rationale)**
...
<!-- slide title="기술 카드 + 학습 사이클 읽는 법" screenshot="" -->
**사용 기술 카드**
