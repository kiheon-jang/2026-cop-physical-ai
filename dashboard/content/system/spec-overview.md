...
screenshot: ""
---
<!-- slide title="프로젝트 목적과 대시보드 역할" -->
## 프로젝트 목적

CoP Physical AI는 정비현장의 PCB 작업(픽앤플레이스, RS232 HHT 케이블 분리)을 로봇팔에 자동화하는 것을 목표로 하는 사내 커뮤니티 오브 프랙티스(CoP) 프로젝트다. Physical AI / Embodied AI 기술을 내재화하기 위해 2026년 4월~10월(6개월 + 시연)로 진행된다.
...
현재 기준(2026-09): Phase 4 — RS232 케이블 분리 단계로, 시뮬 학습과 측정을 마쳤습니다.

<!-- slide title="프로젝트 단계 요약" -->
## 프로젝트 단계 요약
...
- **Phase 3** (8월): S1 리셋버튼 — 제어반 PCB 리셋버튼 누르기 시뮬(실기 트랙과 동일 작업), 시뮬 4-seed 0.925
- **Phase 4** (9월): RS232 케이블 분리 + 1차 기능 완성 — 시뮬 측정 부분성공 0.875 · 완전분리 0.75
- **시연** (10월): 통합 시연 + 사내 발표
